...
def study_case_1():
    print("=== STUDI KASUS 1: UDIN PET SHOP ===")
    ...
    permintaan['tinggi'] = fuzz.trimf(permintaan.universe, [0, 200, 300])

    harga_item['murah'] = fuzz.trimf(harga_item.universe, [0, 0, 40000])
    harga_item['sedang'] = fuzz.trimf(harga_item.universe, [30000, 50000, 100000])
    harga_item['mahal'] = fuzz.trimf(harga_item.universe, [50000, 100000, 100000])
